    ...
    if pretrained:
        ...
        if hr:
            ...
            model.load_state_dict(
                torch.load(path_to_dir + '/weights/darknet19_hr_75.52_92.73.pth', map_location='cuda'), strict=False)
        else:
...
def darknet53(pretrained=False, hr=False, **kwargs):
    ...
    if pretrained:
        ...
        if hr:
            ...
            model.load_state_dict(torch.load(path_to_dir + '/weights/darknet53_hr_77.76.pth', map_location='cuda'),
                                  strict=False)
        else:
