...
def box_transform_inv(box, deltas):
    ...
    Arguments:
    box = (grid_anchor) -- shape (N, 4), shape(c_x, c_y, w, h), 是grid的中心坐标
    deltas = (prediction value) -- shape (N, 4), (σ(t_x), σ(t_y), exp(t_w), exp(t_h))
